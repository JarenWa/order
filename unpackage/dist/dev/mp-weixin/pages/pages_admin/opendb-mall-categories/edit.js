...
const _sfc_main = {
  ...
  methods: {
    ...
    getDetail(id) {
      common_vendor.index.showLoading({ mask: true });
      db.collection(dbCollectionName).doc(id).field("name,sort,description").get().then((res) => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    k: common_vendor.sr("form", "49629d70-0"),
    l: common_vendor.p({
      model: $data.formData,
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/pages_admin/opendb-mall-categories/edit.js.map
