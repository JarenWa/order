  ...
  methods: {
    async loadOrderDetail() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/pages_admin/uni-pay-orders/edit.vue:67", "加载订单失败", err);
    ...
    async submitEdit() {
      ...
      try {
        ...
        common_vendor.index.hideLoading();
        common_vendor.index.__f__("error", "at pages/pages_admin/uni-pay-orders/edit.vue:110", "修改订单失败", err);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-187a9293"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/pages_admin/uni-pay-orders/edit.js.map
