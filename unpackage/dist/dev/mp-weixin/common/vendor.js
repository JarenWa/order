...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__11B9B7A",
    appName: "order-admin-mp",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const entryPagePath = "pages/index/index";
const subPackages = [
  {
    root: "pages/pages_admin",
    pages: [
      {
        path: "index/index",
        style: {
      ...
      {
        path: "opendb-mall-categories/list",
        style: {
          navigationBarTitleText: "分类管理"
        }
      },
      {
        path: "opendb-mall-categories/add",
        style: {
          navigationBarTitleText: "新增分类"
        }
      },
      {
        path: "opendb-mall-categories/edit",
        style: {
          navigationBarTitleText: "编辑分类"
        }
      },
      {
        path: "opendb-mall-categories/detail",
        style: {
          navigationBarTitleText: "分类详情"
        }
      },
      {
        path: "opendb-mall-goods/list",
        style: {
          navigationBarTitleText: "商品管理"
        }
      },
      {
        path: "opendb-mall-goods/add",
        style: {
          navigationBarTitleText: "新增商品"
        }
      },
      {
        path: "opendb-mall-goods/edit",
        style: {
          navigationBarTitleText: "编辑商品"
        }
      },
      {
        path: "opendb-mall-goods/detail",
        style: {
          navigationBarTitleText: "商品详情"
        }
      },
      {
        path: "uni-pay-orders/list",
        style: {
          navigationBarTitleText: "订单管理"
        }
      },
      {
        path: "uni-pay-orders/add",
        style: {
          navigationBarTitleText: "新增订单"
        }
      },
      {
        path: "uni-pay-orders/edit",
        style: {
          navigationBarTitleText: "编辑订单"
        }
      },
      {
        path: "uni-pay-orders/detail",
        style: {
          navigationBarTitleText: "订单详情"
        }
      }
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.0.101"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/Tools/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"order-1","spaceId":"mp-9e7a79aa-2383-4c00-ad3b-9d4db4a25765","clientSecret":"YVHYN/fqRCkrtJWZz04YZA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__11B9B7A";
} catch (e2) {
